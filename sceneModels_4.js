...
sceneModels_4[0].kDiff_4 = [ 1.0, 1.0, 1.0 ];
sceneModels_4[0].tx_4 = -0.50; sceneModels_4[0].ty_4 = 0.84;
sceneModels_4[0].sx_4 = 0.06; sceneModels_4[0].sy_4 = 0.06; sceneModels_4[0].sz_4 = 0.06;

// NUCLEO H2
sceneModels_4.push( new sphereModel_4( 6 ) );
sceneModels_4[1].traZZOn_4 = true;
sceneModels_4[1].kDiff_4 = [ 1.0, 1.0, 1.0 ];
sceneModels_4[1].tx_4 = 0.50; sceneModels_4[1].ty_4 = 0.84;
sceneModels_4[1].sx_4 = 0.06; sceneModels_4[1].sy_4 = 0.06; sceneModels_4[1].sz_4 = 0.06;

// ELETRAO NUCLEO H1
sceneModels_4.push( new sphereModel_4( 6 ) );
sceneModels_4[2].traZZOn_4 = true;
sceneModels_4[2].kDiff_4 = [ 1.0, 1.0, 1.0 ];
sceneModels_4[2].tx_4 = 0.25; sceneModels_4[2].ty_4 = 0.43;
sceneModels_4[2].sx_4 = 0.03; sceneModels_4[2].sy_4 = 0.03; sceneModels_4[2].sz_4 = 0.03;

// ELETRAO NUCLEO H2
sceneModels_4.push( new sphereModel_4( 6 ) );
sceneModels_4[3].traZZOn_4 = true;
sceneModels_4[3].kDiff_4 = [ 1.0, 1.0, 1.0 ];
sceneModels_4[3].tx_4 = -0.25; sceneModels_4[3].ty_4 = 0.43; 
...
sceneModels_4[4].tx_4 = 0; sceneModels_4[4].ty_4 = 0;
sceneModels_4[4].sx_4 = 0.1; sceneModels_4[4].sy_4 = 0.1; sceneModels_4[4].sz_4 = 0.1;

// ELETRAO 1 DENTRO NUCLEO O 
sceneModels_4.push( new sphereModel_4( 6 ) );
sceneModels_4[5].traZZOn_4 = true;
sceneModels_4[5].kDiff_4 = [ 1.0, 0.0, 0.0 ];
sceneModels_4[5].tx_4 = 0; sceneModels_4[5].ty_4 = 0.25;
...
sceneModels_4[6].tx_4 = 0; sceneModels_4[6].ty_4 = -0.25;
...
sceneModels_4[7].tx_4 = 0.5; sceneModels_4[7].ty_4 = 0;
